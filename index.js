...
function hungryDog(weight, age){
  ...
  else if (weight <=0.585){
    return weight * 0.05;
  }
  else {
    return weight * 0.04;s
  }
...
function annoyingSong(bottles){
        for(bottles>0; bottles--){
          return "${bottles} bottles of soda on the wall, ${bottles} bottles of soda, take one down pass it around ${bottlesa-1} bottles of soda on the wall"
